...
import { GUI } from "../plugins/dat.gui.module.js";
import { GPUComputationRenderer } from "../plugins/GPUComputationRenderer.js";
import $ from 'jquery'
...
export default {
  ...
  methods: {
    ...
    BirdGeometryF() {
      ...
      var birdColors = new THREE.BufferAttribute(
        new Float32Array(points * 3),
        3
      );
      var references = new THREE.BufferAttribute(
