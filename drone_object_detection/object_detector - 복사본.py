...
def start_object_detector(image):
...
PATH_TO_TEST_IMAGES_DIR = 'test_images'
image_path = os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image8.jpg')
image = Image.open(image_path)
image_np = load_image_into_numpy_array(image)
result = start_object_detector(image_np)
plt.imshow(result)
plt.show()
...
#     for i in range(sec):
#         image_path = os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format((i%2)+1))
#         image = Image.open(image_path)
#         image_np = load_image_into_numpy_array(image)
#         result = start_object_detector(image_np)
